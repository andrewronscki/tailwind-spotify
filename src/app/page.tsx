			...
			<div className="flex flex-1">
				...
				<main className="flex-1 p-6">
					...
					<div className='grid grid-cols-3 gap-6 mt-4'>
						<a href='#' className='group bg-white/5 flex items-center gap-4 rounded-md overflow-hidden hover:bg-white/10 transition-colors'>
					...
					<h2 className='font-semibold text-2xl mt-10'>Made for André Wronscki Ricardo</h2>
